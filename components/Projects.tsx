	...
	const projects: Project[] = [
		{
			...
			tech: [
				t('techStack.react'),
				t('techStack.typescript'),
				t('techStack.tailwind'),
				t('techStack.motion'),
			],
			features: [
			...
			highlights: {
				performance: t('performanceScores.lighthouse92'),
				accessibility: t('accessibilityLevels.wcag21AA'),
				responsive: t('responsiveTerms.mobileFirst'),
			},
		...
		},
		{
			...
			tech: [
				t('techStack.react'),
				t('techStack.typescript'),
				t('techStack.storybook'),
				t('techStack.designSystem'),
			],
			features: [
			...
			highlights: {
				performance: t('performanceScores.lighthouse89'),
				accessibility: t('accessibilityLevels.wcag21AA'),
				responsive: t('responsiveTerms.adaptiveDesign'),
			},
		...
		},
		{
			...
			highlights: {
				performance: t('performanceScores.lighthouse95'),
				accessibility: t('accessibilityLevels.wcag21AAA'),
				responsive: t('responsiveTerms.progressiveEnhancement'),
			},
		...
		},
		{
			...
			highlights: {
				performance: t('performanceScores.lighthouse96'),
				accessibility: t('accessibilityLevels.wcag21AA'),
				responsive: t('responsiveTerms.mobileFirst'),
			},
			category: 'Vanilla JS',
		...
		},
		{
			...
			highlights: {
				performance: t('performanceScores.lighthouse91'),
				accessibility: t('accessibilityLevels.wcag21AA'),
				responsive: t('responsiveTerms.responsiveDesign'),
			},
